...
rm -rf win7 win7.img
curl -L -o win7.gz https://go.aank.me/win/win7lite.img.gz
echo "Wait.."
gunzip win7.gz
mv win7 win7.img
...
$endc$enda""";
sudo qemu-system-x86_64 -vnc :0 -hda win7.img  -smp cores=2  -m 16384M -machine usb=on -device usb-tablet > /dev/null 2>&1
sleep 43200
